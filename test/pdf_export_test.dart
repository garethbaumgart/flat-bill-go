  ...
  group('PDF Export Tests', () {
    ...
    setUp(() {
      ...
      testBill = Bill(
        ...
        electricityReading: MeterReading(opening: 1000.0, closing: 1100.0),
        waterReading: MeterReading(opening: 200.0, closing: 208.0),
        sanitationReading: MeterReading(opening: 200.0, closing: 208.0),
        electricityTariff: Tariff(steps: [TariffStep(upToUnits: 100.0, rate: 3.25)]),
        waterTariff: Tariff(steps: [
          TariffStep(upToUnits: 6.0, rate: 19.75),
          TariffStep(upToUnits: 15.0, rate: 32.55),
          TariffStep(upToUnits: 30.0, rate: 45.20),
        ]),
        sanitationTariff: Tariff(steps: [
          TariffStep(upToUnits: 6.0, rate: 24.42),
          TariffStep(upToUnits: 15.0, rate: 19.54),
          TariffStep(upToUnits: 30.0, rate: 28.75),
        ]),
      );
    });
