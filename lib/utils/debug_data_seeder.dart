...
class DebugDataSeeder {
  ...
  static Bill _createSampleBill({
    ...
    required double electricityOpen,
    required double electricityClose,
    required double waterOpen,
    required double waterClose,
    required double sanitationOpen,
    required double sanitationClose,
